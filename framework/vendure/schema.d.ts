...
export type AnimationItem = Node & {
  ...
  author: Customer
  video?: Maybe<AnimationVideo>
}

export type AnimationItemList = PaginatedList & {
  __typename?: 'AnimationItemList'
  items: Array<AnimationItem>
  totalItems: Scalars['Int']
}

export type AnimationVideo = Node & {
...
export type AnimationVideoList = PaginatedList & {
  __typename?: 'AnimationVideoList'
  items: Array<AnimationVideo>
  totalItems: Scalars['Int']
}

export type AnimationVideoListOptions = {
  skip?: Maybe<Scalars['Int']>
  take?: Maybe<Scalars['Int']>
  sort?: Maybe<AnimationVideoSortParameter>
  filter?: Maybe<AnimationVideoFilterParameter>
}

export type AnimationVideoSortParameter = {
  id?: Maybe<SortOrder>
...
export type Mutation = {
  ...
  submitAnimationVideo: AnimationVideo
  submitAnimationItem: AnimationItem
}
...
export type MutationSubmitAnimationVideoArgs = {
  input: SubmitAnimationVideoInput
}

export type MutationSubmitAnimationItemArgs = {
  input: SubmitAnimationItemInput
}
...
export type Query = {
  ...
  animationsVideos: AnimationVideoList
  animationVideo?: Maybe<AnimationVideo>
}
...
export type QueryAnimationsVideosArgs = {
  options?: Maybe<AnimationVideoListOptions>
}

export type QueryAnimationVideoArgs = {
  id: Scalars['ID']
}
...
export type AddAnimationMutationVariables = Exact<{
  input: SubmitAnimationVideoInput
}>

export type AddAnimationMutation = { __typename?: 'Mutation' } & {
  submitAnimationVideo: { __typename?: 'AnimationVideo' } & Pick<
    AnimationVideo,
    'id'
  >
}
